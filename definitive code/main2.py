...
# Definieer de MQ131Class-klasse
class MQ131Class:
...
# Definieer andere instellingen en initialisaties
...
with open(filename, 'a') as data_file:
    data_file.write("meter, pressure_hpa, bmp280_temp, CO2, O3\n")
...
def calculate_altitude(sea_level_pressure, measured_pressure):
    ...
    altitude = T0/0.0065 * (1 - (measured_pressure / sea_level_pressure) ** (1 / 5.255))
    return altitude
...
while True:
    ...
    msg = f"{altitude:.2f}, {pressure:.2f}, {temp:.2f}, {CO2waarde:.2f}, {O3_ppm:.2f}"
    print(msg)
